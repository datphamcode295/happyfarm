...
class Fan extends Component {
  ...
  clickToggle(status) {
    fetch(`https://io.adafruit.com/api/v2/${this.props.route.params.username}/feeds/fan/data?X-AIO-Key=${this.props.route.params.password}`, {
      method: 'POST',
      headers: {
  ...
  componentDidMount(){
    const adalink = `https://io.adafruit.com/api/v2/${this.props.route.params.username}/feeds/fan/data?X-AIO-Key=${this.props.route.params.password}`
